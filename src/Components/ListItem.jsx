...
function ListItem({ item }) {
  ...
  return (
    <div className="list-item d-flex my-2">
      <div className="li-left w-50 d-flex align-items-center justify-content-between">
        <span className="item-name">{name} :</span>
        <span className="item-quantity">{quantity}</span>
      </div>
      <div className="li-right w-50 d-flex align-items-center justify-content-center">
        <button
